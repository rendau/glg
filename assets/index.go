...
// templatesCoreTmpl reads file data from disk. It returns an error on failure.
func templatesCoreTmpl() (*asset, error) {
	path := "/Users/dauren/Documents/rendau/glg/templates/core.tmpl"
	name := "templates/core.tmpl"
...
// templatesInterfacesTmpl reads file data from disk. It returns an error on failure.
...
// templatesRest_routerTmpl reads file data from disk. It returns an error on failure.
func templatesRest_routerTmpl() (*asset, error) {
	path := "/Users/dauren/Documents/rendau/glg/templates/rest_router.tmpl"
	name := "templates/rest_router.tmpl"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
